...
<body>
      ...
      <div class="card-header bg-primary text-light">
        <div class="row">
          ...
          <div class="col-md-6 text-end">
            <button class="btn btn-success btn-sm" id="abrir-modal" data-bs-toggle="modal" data-bs-target="#modal-registro-cursos"><i class="bi bi-plus-circle-fill"></i> Agregar curso</button>
          </div>
        </div>
      </div>
      <div class="card-body">
  ...
  <script>
    $(document).ready(function(){
      ...
      // let cmabia de valor constante
      let datosNuevos = true;
      let idcursoactualizar = -1; // Se le puede enviar -1 como valor inprovable
      ...
      function registrarCurso(){
        ...
        //prompt: muestra alerta para escribir

        //const nombre = prompt("Escribe tu nombre");
        //alert(`Un gusto conocerte ${nombre}`);
      ...
      // Cambiamos el titulo del modal actualizar
      function abrirModal(){
        datosNuevos = true; //Varibale de tipo BANDERA
      ...
      //Al pulsar clic sobre boton ROJO, se elimine el registro
      ...
      //Detectar clic en EDITAR(asincrono)
      ...
      $("#tabla-cursos tbody").on("click",".editar", function(){
        ...
        $.ajax({
          ...
          success: function(result){
            ...
            //Retornamos los valores a los controles de FROM
